...
public class UpdateCommentSubscriber implements ApplicationListener<UpdateCommentEvent> {
  ...
  public void onApplicationEvent(UpdateCommentEvent event) {
    ...
    log.info("==》评论事件消费成功，commentId：{}", commentId);
   ...
   * @param domain
   */
  private void notifyBeCommentedUser(
      Long replyCommentId, String blogName, String nickname, String content, String domain) {
